...
import airlinemanagementsystem.ThemeManager;
...
public class BookTicketController {
    ...
    public void initialize() {
        ...
        try {
            ...
            trainImage.setImage(new Image(
                    getClass().getResource("/airlinemanagementsystem/icons/train_icon.png").toExternalForm()));
        } catch (Exception e) {
    ...
    private void handleFetchUser() {
        ...
        try {
            Conn conn = new Conn();
            String query = "select * from users where cnic = '" + cnic + "'";
            ...
            if (rs.next()) {
                ...
                showAlert(Alert.AlertType.ERROR, "Not Found", "User not found with this CNIC");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void handleBookTicket() {
        ...
        try {
            ...
            if ("AC Standard".equals(sClass))
                multiplier = 1.5;
            else if ("AC Business".equals(sClass))
                multiplier = 2.0;

            double totalAmount = basePrice * selectedSeats.size() * multiplier;
